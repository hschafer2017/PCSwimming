...
class TestEditViews(TestCase): 
    def test_get_edit_post(self): 
        ...
        # post = Post.objects.update(title='Test Discussion Post', 
        #         content='Test Discussion Post Edit Content')
...
class TestDeleteViews(TestCase): 
    ...
    def test_get_delete_comment(self): 
        ...
        for message in get_messages(response.wsgi_request):
            self.assertNotEqual('The comment could not be deleted.', messages)
